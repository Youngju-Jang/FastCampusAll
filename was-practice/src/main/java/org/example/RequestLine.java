...
public class RequestLine {
 // GET /calculate?operand=11&operator=*&operand2=55  HTTP/1.1
    private final String method; // GET
    private final String urlPath; // /calculate
    private QueryStrings queryStrings; // operand=11&operator=*&operand2=55
    ...
    public RequestLine(String requestLine){
        ...
        if(urlPathTokens.length == 2) {
            this.queryStrings = new QueryStrings(urlPathTokens[1]); // operand=11&operator=*&operand2=55
        }
    }
